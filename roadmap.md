...
> P1-4（会话超时与清理）、P1-5（LLM 重试）、P1-3（Prompt 模板化）已完成，见 CHANGELOG v0.4.0。
> P1-1（意图路由升级）、P1-2（前端组件拆分）、P1-6（实现 redo 能力）已完成，见 CHANGELOG v0.5.0。
...
Phase 2 (P1)     [P1-4✓][P1-5✓][P1-3✓]   [P1-1✓][P1-2✓]   [P1-6✓]  ← 全部完成
                       ← v0.4.0 →           ← v0.5.0 →
...
- **Phase 2 已完成**：P1-4/P1-5/P1-3（v0.4.0）、P1-1/P1-2/P1-6（v0.5.0），Phase 2 结束。
- **Phase 3**：按功能分批发布，每批一个 MINOR（如 0.6.0、0.7.0）。
